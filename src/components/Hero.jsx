      ...
      <section className="relative z-10 pt-8 max-xl:text-center">
        ...
        <h1
          className="
            ...
            font-extrabold leading-[1.3.8]  text-white
            max-xl:mx-auto
          "
        >
          {hero.title1}
        ...
        <div className="hero-animate flex flex-wrap items-center gap-5 max-xl:justify-center max-md:w-full">
          <MagneticButton
            ...
            className="
              ...
              px-8 py-4 font-extrabold text-white
...
>
  ...
  <div className="absolute right-1/2 top-[8%] z-10 translate-x-1/2">
    <div
      ref={cardRef}
      className="
        group relative h-[570px] w-[390px]
        animate-[cardFloat_5s_ease-in-out_infinite]
        overflow-hidden rounded-[34px] border-2 border-[#6aa9ff]/70
        ...
        hover:scale-[1.025]
        hover:border-[#b041ff]/80
        hover:shadow-[0_0_80px_rgba(47,140,255,.55),0_0_150px_rgba(176,65,255,.25),30px_45px_90px_rgba(0,0,0,.7)]
    ...
    >
      <span
        className="
          pointer-events-none absolute left-[-130%] top-0 h-full w-1/2
          rotate-[18deg] bg-gradient-to-r from-transparent via-white/20 to-transparent
          transition-all duration-1000 group-hover:left-[150%]
        "
      />
      ...
      <span
        className="
          ...
          bg-[linear-gradient(120deg,transparent,rgba(255,255,255,.08),transparent)]
      ...
      <h2
        className="
          relative z-10 mt-16 text-4xl font-black leading-tight text-white
      ...
      <div className="relative z-10 my-6 max-sm:my-4">
      ...
      <a
        href="#contact"
        className="
          relative z-10 inline-flex rounded-xl
          bg-gradient-to-br from-[#2f8cff] to-[#b041ff]
      ...
      <div
        className="
          absolute bottom-10 left-8 right-8 z-10 grid grid-cols-3 gap-3
        ...
        {hero.stats.map(([title, desc]) => (
          <div
            ...
            className="
              ...
              transition duration-300 group-hover:bg-white/10
